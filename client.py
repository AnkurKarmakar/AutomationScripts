...
# Examples:
#
#  (1) legacy User/Password login method: Initialize, authenticate, call_api
#  ```
...
#  ```
# (2) API token Login method: Initialize, call_api_token
#  ```
#      client = VcoRequestManager("vcoXX-usvi1.velocloud.net")
#      client.call_api_token("enterprise/getEnterpriseEdges", { "enterpriseId": 1 }, "eyJhbGciOizI1NiIInR5cCI6IkpXVCJ9.ey...")
#
...
class VcoRequestManager(object):
    ...
    def call_api_token(self, method, params, token):
        """
